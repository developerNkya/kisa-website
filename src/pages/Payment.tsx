  ...
  const pay = (e: React.FormEvent) => {
    ...
    window.setTimeout(() => {
      ...
      toast.success('Malipo yamethibitishwa', {
        description: 'KISA Premium yako imeanza. Karibu!'
      });
    }, 1600);
  };
      ...
      <div className="mt-9 grid gap-6 lg:grid-cols-[1.3fr_1fr] lg:items-start">
        <div className="rounded-2xl border border-line-soft bg-surface p-5 sm:p-7">
          ...
          <div className="py-6 text-center">
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:justify-center">
                <Button onClick={() => navigate('/hadithi')} size="lg">
                  Anza kusoma
                </Button>
                <Button variant="secondary" size="lg" onClick={() => navigate('/akaunti')}>
                  Nenda kwenye akaunti
                </Button>
              </div>
            </div> :
          stage === 'pending' ?
          <div className="py-10 text-center">
              ...
              <p className="mx-auto mt-2 max-w-sm text-sm text-mist">
                Angalia simu yako {phone || 'yako'} na weka namba ya siri ya {paymentMethods.find((m) => m.id === method)?.name} ili kukamilisha malipo ya TZS 2,000.
              </p>
            </div> :
          ...
          <form onSubmit={pay} className="space-y-6">
            ...
            <div
              ...
              <fieldset>
                ...
                <label
                  ...
                  className={cn(
                    ...
                    'border-line bg-surface-raised hover:border-mist/40'
                  )}>
              ...
              required
              hint="Utapokea ujumbe wa kuthibitisha malipo kwenye namba hii." />
        ...
        <aside className="rounded-2xl border border-gold/25 bg-[#171112] p-5 sm:p-6">
          ...
          <ul className="mt-5 space-y-2 border-t border-line-soft pt-5">
            ...
            <li key={b} className="text-[13px] text-mist">
                ✓ {b}
              </li>
            )}
          </ul>
